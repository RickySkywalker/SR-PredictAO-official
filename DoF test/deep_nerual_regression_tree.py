...
class NeuralRegressionTree(nn.Module):
    def __init__(self,
                 depth,
                 num_features,
                 used_features_rate,
        ...
        super(NeuralRegressionTree, self).__init__()
        self.depth = depth
        ...
        self.decision_fn_1 = nn.Linear(num_used_features, self.num_leaves, device=self.device)
        ...
        self.mu_dropout = nn.Dropout(dropout_rate)
    ...
    def forward(self, features):
        ...
        # JS-estimator
        features = (1 - (batch_size - 2)/(th.norm(features, dim=0))**2)*features

...
print("test name: para-8")
print("changes made:")
print("\t1. from para-3, change tree_num to 128, depth to 5")
print("\t2. cancel weight decay")
...
parser.add_argument('--epoch', type=int, default=256, help='the number of epochs to train for 100')
